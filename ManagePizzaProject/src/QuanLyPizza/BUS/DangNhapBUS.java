...
public class DangNhapBUS {
    ...
    public TaiKhoan getTaiKhoanDangNhap(String user, String password, boolean selected) throws Exception {
...
//            new MyDialog("Vì tình hình dịch Covid phức tạp, cửa hàng chỉ thực hiện bán mang về!", MyDialog.INFO_DIALOG);
    ...
    private int kiemTraDangNhap(String user, String password) throws Exception {
