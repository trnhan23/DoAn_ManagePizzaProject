...
public class PhanQuyenBUS {
    ...
    public boolean suaQuyen(String tenQuyen, int nhapHang, int sanPham,int giamGia, int nhanVien, int khachHang, int thongKe) {
        PhanQuyen phanQuyen = new PhanQuyen(tenQuyen, nhapHang, sanPham,giamGia, nhanVien, khachHang, thongKe);
    ...
    public boolean themQuyen(String tenQuyen) {
        ...
        PhanQuyen phanQuyen = new PhanQuyen(tenQuyen, 0, 0, 0, 0, 0,0);
