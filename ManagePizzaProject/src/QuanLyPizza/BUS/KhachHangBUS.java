...
public class KhachHangBUS {
    ...
    public ArrayList<KhachHang> timKiemKhachHang(String tuKhoa) {
        ...
        for (KhachHang kh : listKhachHang) {
            ...
            if (ho.contains(tuKhoa) || ten.contains(tuKhoa) || sdt.contains(tuKhoa)) {
                dskh.add(kh);
            }
        }
        return dskh;
    ...
    public boolean themKhachHang(String ho, String ten, String sdt, String email) {
        if (ten.trim().equals("")) {
            new MyDialog("Không được để trống tên!", MyDialog.ERROR_DIALOG);
            return false;
        }
        if (sdt.equals("Chọn giới tính")) {
    ...
    public boolean suaKhachHang(String ma, String ho, String ten, String sdt, String email) {
        if (ten.trim().equals("")) {
            new MyDialog("Không được để trống tên!", MyDialog.ERROR_DIALOG);
            return false;
        }
