...
public class SanPhamBUS {
    ...
    public void docListSanPham() {
     ...
     public void docListSanPhamConBan() {
        listSanPham = spDAO.getListSanPhamConBan();
    }
     public void docListSanPhamNgungBan() {
        listSanPham = spDAO.getListSanPhamNgungBan();
    }
      public void docListSanPhamBan() {
        listSanPham = spDAO.getListSanPhamBan();
    }
    ...
    public ArrayList<SanPham> getListSanPhamConBan() {
        //if (listSanPham == null) {
            docListSanPhamConBan();
       // }
        return listSanPham;
    ...
    public ArrayList<SanPham> getListSanPhamNgungBan() {
        //if (listSanPham == null) {
            docListSanPhamNgungBan();
       // }
        return listSanPham;
    }
    
    public ArrayList<SanPham> getListSanPhamBan() {
        //if (listSanPham == null) {
            docListSanPhamBan();
       // }
        return listSanPham;
    ...
    public boolean themSanPham(String ten,
        ...
        if (ten.trim().equals("")) {
            new MyDialog("Tên sản phẩm không được để rỗng!", MyDialog.ERROR_DIALOG);
            return false;
        }
    ...
    public boolean banLaiSanPham(String ma) {
        if (ma.trim().equals("")) {
        ...
        int maSP = Integer.parseInt(ma);
        if (spDAO.banLaiSanPham(maSP)) {
            new MyDialog("Đã khôi phục sản phẩm!", MyDialog.SUCCESS_DIALOG);
            return true;
        }

        new MyDialog("Khôi phục thất bại!", MyDialog.ERROR_DIALOG);
        return false;
    }
