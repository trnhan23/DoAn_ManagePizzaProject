...
public class DlgSuaNhaCungCap extends javax.swing.JDialog {
    ...
    private boolean checkSuaNCC = false;
     ...
     public static final Logger logger = Logger.getLogger(DlgSuaNhaCungCap.class);
     void init(){
    ...
    private void initComponents() {
        ...
        txtDienThoaiNCC.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtDienThoaiNCCKeyTyped(evt);
            }
        });
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        ...
        String quyen = DangNhapBUS.taiKhoanLogin.getQuyen();
            ...
            logger.info(quyen +" "+logname+" sửa nhà cung cấp: "+ txtMaNCC.getText());
            this.dispose();
        }
    ...
    private void txtDienThoaiNCCKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDienThoaiNCCKeyTyped
         char c = evt.getKeyChar();
        String phoneNumber = txtDienThoaiNCC.getText();
    ...
    }//GEN-LAST:event_txtDienThoaiNCCKeyTyped
