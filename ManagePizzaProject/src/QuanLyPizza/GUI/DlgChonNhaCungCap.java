...
public class DlgChonNhaCungCap extends javax.swing.JDialog {
    ...
    public DlgChonNhaCungCap() {
     ...
     public static final Logger logger = Logger.getLogger(DlgChonNhaCungCap.class);
     void init(){
    ...
    private void customControls() {
        ...
        tblNhaCungCap.getColumnModel().getColumn(0).setCellRenderer(centerRenderer);
        tblNhaCungCap.getColumnModel().getColumn(1).setCellRenderer(centerRenderer);
        tblNhaCungCap.getColumnModel().getColumn(2).setCellRenderer(centerRenderer);
        tblNhaCungCap.getColumnModel().getColumn(3).setCellRenderer(centerRenderer);
