...
import Filters.NumberOnlyFilter;
...
public class PnQuanLyBanHangGUI extends JPanel {
    ...
    JTextField txtMaSPBanHang, txtTenSPBanHang, txtDonGiaBanHang, txtTimKiem;
    ...
    //JTextField txtMinSearch, txtMaxSearch, txtMinNgayLap, txtMaxNgayLap, txtThanhToan;
    JTextField txtMinSearch, txtMaxSearch;
    JTextField txtThanhToan;
    JDateChooser dateMinSearch, dateMaxSearch, dateMinNgayLap, dateMaxNgayLap;
    ...
    private void addControlsBanHang() {
        ...
        Font font1 = new Font("", Font.PLAIN, 17);
        ...
        JLabel lblTimKiem = new JLabel("Tìm món");
        lblTimKiem.setFont(new Font("Arial", Font.BOLD, 20));
        txtTimKiem = new JTextField(20);
        txtTimKiem.setFont(new Font("Arial", Font.BOLD, 20));
        pnTimKiem.add(lblTimKiem);
        pnTimKiem.add(txtTimKiem);
        //pnTimKiem.add(btnTim);
        //pnTableBanHang.add(pnTimKiem, BorderLayout.NORTH);

        JPanel pnTitleAndSearch = new TransparentPanel();
        pnTitleAndSearch.setLayout(new BoxLayout(pnTitleAndSearch, BoxLayout.Y_AXIS));

// Thêm pnTitleBanHang và pnTimKiem vào pnTitleAndSearch
        pnTitleAndSearch.add(pnTitleBanHang);
        pnTitleAndSearch.add(pnTimKiem);

        pnTableBanHang.add(pnTitleAndSearch, BorderLayout.NORTH);

        dtmSanPhamBan = new DefaultTableModel();
        dtmSanPhamBan.addColumn("Mã sản phẩm");
        ...
        columnModelBanHang.getColumn(1).setPreferredWidth(220);
        columnModelBanHang.getColumn(2).setPreferredWidth(82);
        columnModelBanHang.getColumn(3).setPreferredWidth(85);
        columnModelBanHang.getColumn(4).setPreferredWidth(110);
        ...
        dtmGioHang.addColumn("Mã sản phẩm");
        ...
        columnModelGioHang.getColumn(1).setPreferredWidth(250);
        columnModelGioHang.getColumn(2).setPreferredWidth(110);
        ...
        lblTitleThongTin.setFont(new Font("Arial", Font.BOLD, 20));
        ...
        pnAnhSanPham.setPreferredSize(new Dimension((int) pnThongTinBanHang.getPreferredSize().getWidth(), 150));
        lblAnhSP = new JLabel();
        lblAnhSP.setBorder(BorderFactory.createLineBorder(Color.gray));
        lblAnhSP.setPreferredSize(new Dimension(170, 150));
        ...
        pnTemp.add(btnXoaSPGioHang, BorderLayout.WEST);
        pnTemp.add(btnXuatHoaDonSP, BorderLayout.EAST);
        pnButtonBanHang.setPreferredSize(new Dimension((int) pnThongTinBanHang.getPreferredSize().getWidth(), 50));
        pnButtonBanHang.add(pnTemp, BorderLayout.CENTER);
...
//                pnButtonBanHang.add(pnTemp);
        ...
        pnLeftBanHang.setPreferredSize(new Dimension(618, h - 120));
        pnTableBanHang.setPreferredSize(new Dimension(618, (500) / 2));
        pnTableGioHang.setPreferredSize(new Dimension(618, (500) / 2));
        pnLeftBanHang.add(pnTableBanHang);
        pnLeftBanHang.add(pnTableGioHang);

        Component verticalStrut = Box.createVerticalStrut(100);

        // Thêm dự phòng vào đầu của pnRightBanHang
        pnLeftBanHang.add(verticalStrut);
        ...
        pnRightBanHang.add(pnThongTinBanHang, BorderLayout.NORTH);
...
//                (int) pnTableBanHang.getPreferredSize().getHeight()));
        ...
        // Thêm dự phòng vào đầu của pnRightBanHang
        pnRightBanHang.add(verticalStrut);
        ...
        JLabel lblMaHD, lblNgayLap, lblMaKH, lblMaNV, lblTongTien, lblGhiChu, lblThanhToan, lblMinsearch, lblMaxSearch, lblMinNgay, lblMaxNgay;
        ...
        txtMaHD = new JTextField(x);
        txtMaKH = new JTextField(x);
        txtMaNV = new JTextField(x);
        txtNgayLap = new JTextField(x);
        txtTongTien = new JTextField(x);
        txtGhiChu = new JTextField(x);
        txtThanhToan = new JTextField(x);
...
//        txtMaxNgayLap = new JTextField(7);
        ...
        JPanel pnThanhToan = new TransparentPanel(new FlowLayout());
        pnThanhToan.add(lblThanhToan);
        lblThanhToan.setFont(font);
        txtThanhToan.setFont(font);
        pnThanhToan.add(txtThanhToan);
        pnCTHoaDonLeft.add(pnThanhToan);

        Dimension dimenDate = new Dimension(125, 32);
        ...
        txtMinSearch.setDocument(new PlainDocument());
        txtMaxSearch.setDocument(new PlainDocument());

        ((AbstractDocument) txtMinSearch.getDocument()).setDocumentFilter(new NumberOnlyFilter());
        ((AbstractDocument) txtMaxSearch.getDocument()).setDocumentFilter(new NumberOnlyFilter());
        ...
        dateMinNgayLap = new JDateChooser();
        dateMinNgayLap.setDateFormatString("dd/MM/yyyy");
        dateMinNgayLap.getCalendarButton().setPreferredSize(new Dimension(32, 32));
        dateMinNgayLap.getCalendarButton().setIcon(new ImageIcon("image/icons8_calendar_25_20px.png"));

        dateMaxNgayLap = new JDateChooser();
        dateMaxNgayLap.setDateFormatString("dd/MM/yyyy");
        dateMaxNgayLap.getCalendarButton().setPreferredSize(new Dimension(32, 32));
        dateMaxNgayLap.getCalendarButton().setIcon(new ImageIcon("image/icons8_calendar_25_20px.png"));

        dateMaxNgayLap.setFont(font1);
        dateMinNgayLap.setFont(font1);

        dateMaxNgayLap.setPreferredSize(dimenDate);
        dateMinNgayLap.setPreferredSize(dimenDate);

        Calendar currentDate = Calendar.getInstance();
        dateMaxNgayLap.setDate(currentDate.getTime());
        currentDate.add(Calendar.DAY_OF_MONTH, -1);
        dateMinNgayLap.setDate(currentDate.getTime());
//        txtMinNgayLap.setFont(font);
//        txtMaxNgayLap.setFont(font);
        pnSearchDate.add(lblMinNgay);
        //pnSearchDate.add(txtMinNgayLap);
        pnSearchDate.add(dateMinNgayLap);
        pnSearchDate.add(lblMaxNgay);
        // pnSearchDate.add(txtMaxNgayLap);
        pnSearchDate.add(dateMaxNgayLap);

        pnCTHoaDonLeft.add(pnSearchDate);
        pnCTHoaDonLeft.add(pnSearchPrice);

        Dimension lblHoaDonSize = lblMaNV.getPreferredSize();
        ...
        lblThanhToan.setPreferredSize(lblHoaDonSize);
        ...
        pnListHoaDon.add(scrHoaDon, BorderLayout.CENTER);
        //pnListHoaDon.add(listHoaDon);
        ...
        lblMaHDCT = new JLabel("Mã hoá đơn");
        ...
        Dimension lblCTHDSize = lblMaHDCT.getPreferredSize();
        ...
        dtmCTHoaDon.addColumn("Mã hoá đơn");
        dtmCTHoaDon.addColumn("Mã sản phẩm");
        ...
        tblCTHoaDon.getColumnModel().getColumn(0).setCellRenderer(centerRenderer);
        tblCTHoaDon.getColumnModel().getColumn(1).setCellRenderer(centerRenderer);
        tblCTHoaDon.getColumnModel().getColumn(2).setCellRenderer(centerRenderer);
        tblCTHoaDon.getColumnModel().getColumn(3).setCellRenderer(centerRenderer);
        tblCTHoaDon.getColumnModel().getColumn(4).setCellRenderer(centerRenderer);

        TableColumnModel columnModelHoaDon = tblCTHoaDon.getColumnModel();
        columnModelHoaDon.getColumn(0).setPreferredWidth(50);
        columnModelHoaDon.getColumn(1).setPreferredWidth(50);
        columnModelHoaDon.getColumn(2).setPreferredWidth(50);
        columnModelHoaDon.getColumn(3).setPreferredWidth(50);
        columnModelHoaDon.getColumn(4).setPreferredWidth(50);
...
//        dateMaxSearch.addPropertyChangeListener(new PropertyChangeListener() {
//            @Override
...
//        });
        ...
        btnResetHoaDon.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                txtMaxSearch.setText("0");
                txtMinSearch.setText("0");
        ...
        txtMaxSearch.getDocument().addDocumentListener(new DocumentListener() {
            @Override
            public void insertUpdate(DocumentEvent e) {
                xuLyTimTheoKhoangNgay();
                xuLyTimTheoKhoangGia();
...
//        });
    ...
    private void loadDataTableSanPhamBan() {
        ...
        if (!"".equals(txtTimKiem.getText().trim())) {
            String ten = txtTimKiem.getText().toLowerCase();
            dtmSanPhamBan.setRowCount(0);
            dssp = spBUS.getSanPhamTheoTen(ten);
    ...
    private void addDataListHoaDon(ArrayList<HoaDon> dshd) {
        ...
        if (dshd != null) {
            for (HoaDon hd : dshd) {
                String formattedDateTime = dateTimeFormat.format(hd.getNgayLap());
                listModel.addElement(hd.getMaHD() + " | " + formattedDateTime + " | " + dcf.format(hd.getTongTien()) + " VND");
            }
    ...
    private void xuLyHienCTHoaDon() {
        ...
        String thanhtoan = "";
        if (hd.getThanhToan().equals("bank")) {
            thanhtoan = "Chuyển khoản";
        } else if (hd.getThanhToan().equals("momo")) {
            thanhtoan = "Momo";
        } else {
            thanhtoan = "Tiền mặt";
        }
    ...
    private void loadDataTblCTHoaDon() throws Exception {
    ...
    private void xuLyClickTblCTHoaDon() {
        ...
        if (row > -1) {
            ...
            String tenSP = spBUS.getSanPham(masp).getTenSP();

            txtMaHDCT.setText(maHD);
            txtMaSPCT.setText(tenSP);
    ...
    private void xuLyTimTheoKhoangNgay() {
        ArrayList<HoaDon> listHoaDon = hoaDonBUS.getListHoaDonTheoNgay(dateMinNgayLap.getDate(), dateMaxNgayLap.getDate());
