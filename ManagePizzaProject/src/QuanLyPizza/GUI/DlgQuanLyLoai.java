...
public class DlgQuanLyLoai extends javax.swing.JDialog {
    ...
    public static final Logger logger = Logger.getLogger(DlgQuanLyLoai.class);
     void init(){
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        String quyen = DangNhapBUS.taiKhoanLogin.getQuyen();
            ...
            logger.info(quyen +" "+logname+" thêm mới loại sản phẩm: "+txtTenLoai.getText());
            loadDataLenTblLoai();
        }
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        String quyen = DangNhapBUS.taiKhoanLogin.getQuyen();
            ...
            logger.info(quyen +" "+logname+" xoá loại sản phẩm: "+ma);
                loadDataLenTblLoai();
            }
        }
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        String quyen = DangNhapBUS.taiKhoanLogin.getQuyen();
            ...
            logger.info(quyen +" "+logname+" sửa loại sản phẩm: "+txtTenLoai.getText());
            loadDataLenTblLoai();
        }
