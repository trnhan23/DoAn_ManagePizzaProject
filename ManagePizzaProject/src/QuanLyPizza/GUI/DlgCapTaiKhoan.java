...
public class DlgCapTaiKhoan extends javax.swing.JDialog {
    ...
    public DlgCapTaiKhoan(String maNV) {
     ...
     public static final Logger logger = Logger.getLogger(DlgCapTaiKhoan.class);
     void init(){
    ...
    private void btnTaoTaiKhoanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTaoTaiKhoanActionPerformed
        ...
        logger.info(quyen +" "+logname+ " cấp tài khoản cho: "+(String) cmbQuyen.getSelectedItem()+" với tên đăng nhập: "+txtTenDangNhap.getText());
    ...
    private void loadDataCmbQuyen() {
        ...
        for (PhanQuyen pq : dsq) {
            if (!"Quản Trị".equals(quyen.getQuyen())) {
                if (!"Quản Trị".equals(pq.getQuyen()) && !"Quản Lý".equals(pq.getQuyen())) {
