...
public class XuatPhieuNhapGUI extends javax.swing.JDialog {
    ...
    public static final Logger logger = Logger.getLogger(XuatPhieuNhapGUI.class);
     void init(){
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) throws Exception {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        String[] part = nhaCungCap.split("- "); 
        String ncc = part[1];
        
        logger.info(nhanvien+" đã nhập hàng từ nhà cung cấp: "+ncc+" số tiền: "+tongTien);
        ...
        for (CTPhieuNhap ctpn : listCTPhieuNhap) {
            ...
            hd += "<td style='text-align:center;'>" + dcf.format(ctpn.getThanhTien()) + "</td>";
            hd += "</tr>";
            i++;
            //===================================================
            //===================LƯU CTPN VÀO DB=================
