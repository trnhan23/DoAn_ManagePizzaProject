...
public class DlgQuyen_MatKhau extends javax.swing.JDialog {
    ...
    PhanQuyen quyen = PhanQuyenBUS.quyenTK;
     public static final Logger logger = Logger.getLogger(DlgQuyen_MatKhau.class);
     void init(){
    ...
    public DlgQuyen_MatKhau(String maNV) {
        ...
        pnMatKhauButton2.setVisible(false);
        cmbQuyen.setEnabled(false);
        if ("Quản Trị".equals(quyen.getQuyen())) {
            btnLuuQuyen.setVisible(true);
            pnMatKhauButton2.setVisible(true);
            cmbQuyen.setEnabled(true);
        }
        loadDataCmbQuyen();
    }
    ...
    private void btnLuuQuyenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuQuyenActionPerformed
        ...
        String quyen = DangNhapBUS.taiKhoanLogin.getQuyen();
            ...
            logger.info(quyen +" "+logname+" đặt lại quyền cho người dùng mã: "+maNV+" quyền: "+quyen);
