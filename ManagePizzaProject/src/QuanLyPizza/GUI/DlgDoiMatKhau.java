...
import static QuanLyPizza.GUI.DlgCapTaiKhoan.logger;
...
public class DlgDoiMatKhau extends javax.swing.JDialog {
    ...
    public boolean logout = false;
     public static final Logger logger = Logger.getLogger(DlgDoiMatKhau.class);
     void init(){
    ...
    private void initComponents() {
        ...
        btnDangXuat.setPreferredSize(new java.awt.Dimension(105, 31));
    ...
    private void btnDangXuatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDangXuatActionPerformed
        ...
        logger.info(quyen +" "+logname+ " đăng xuất");
