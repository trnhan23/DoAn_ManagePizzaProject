...
public class ThongKe {
    ...
    public int[] tongTienTheoLoai;

    public ThongKe() {
    }

    public ThongKe(int soLuongSP, int soLuongKH, int soLuongNV, int[] tongThuQuy, ArrayList<SanPham> topSanPhamBanChay, int[] tongTienTheoLoai) {
        this.soLuongSP = soLuongSP;
        this.soLuongKH = soLuongKH;
        this.soLuongNV = soLuongNV;
        this.tongThuQuy = tongThuQuy;
        this.topSanPhamBanChay = topSanPhamBanChay;
        this.tongTienTheoLoai = tongTienTheoLoai;
    }

    public int[] getTongTienTheoLoai() {
        return tongTienTheoLoai;
    }
    public int getTongTienTheoLoai(int i) {
        return tongTienTheoLoai[i-1];
    }

    public void setTongTienTheoLoai(int[] tongTienTheoLoai) {
        this.tongTienTheoLoai = tongTienTheoLoai;
    }
